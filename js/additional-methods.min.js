...
$.validator.addMethod("exactlength", function(value, element, param) {
	...
	}, $.format("{0} caracteres exactamente."));
	...
	}, "Sólo documentos verdaderos");
	
	$.validator.addMethod("TELEFONO", function(value, element) 
	{
		if (/^(9[0-9]{2})[ ]([0-9]{3})[ ]([0-9]{3})$/.test(value)) 
		{ 
			return true;
		} else {
			if(value.length==0)
		...
		return this.optional(element); 
	}, "Teléfono, así­ 9xx xxx xxx"); 
	
	$.validator.addMethod("MOVIL", function(value, element) 
	{
		if (/^(6[0-9]{2})[ ]([0-9]{3})[ ]([0-9]{3})$/.test(value)) 
		{ 
			return true;
		} else {
			if(value.length==0)
...
$.validator.addMethod("SICA", function(value, element) 
{
	if (/^([0-9]{4})-([0-9]{4})-([0-9]{2})-([0-9]{10})$/.test(value)) 
	{ 
		return true;
	} else {
		if(value.length==0)
	...
	return this.optional(element); 
}, "Por favor, escriba el nÃºmero de cuenta de la siguiente forma 9999-9999-99-9999999999");
