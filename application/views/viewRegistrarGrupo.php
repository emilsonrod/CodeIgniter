...
echo form_open('grupo', $attributes); ?>
	...
	<p>
        ...
        <?php
          echo form_input(array('required'=>'required','name'=>'nombreCorto','id'=>'nombreCorto','type'=>'text','placeholder'=>'Nombre acronimo','value'=>set_value('nombreCorto'),'autofocus'=>'autofocus','size'=>'25'));   
        ?>
...
<p>
    ...
    <?php echo form_input(array('required'=>'required','name'=>'nombreLargo','id'=>'nombreLargo','type'=>'text','placeholder'=>'Significado del acronimo','value'=>set_value('nombreLargo'),'autofocus'=>'autofocus','size'=>'25'));?>
        <h5><?php echo form_error('nombreLargo'); ?></h5>
</p>
<p>
		<?php echo form_label('Correo de la Empresa', 'correo')?> <span class="required">*</span><br/>
		<?php echo form_input(array('required'=>'required','name'=>'correo', 'id'=>'correo','type'=>'email', 'value'=>set_value('correo'), 'placeholder' => 'Ingrese email de la empresa', 'autofocus'=>'autofocus', 'size'=>'25'))?>
		<h5><?php echo form_error('correo');?></h5>
</p>
<p>
    <?php echo form_label('Contraseña', 'contrasenya')?> <span class="required">*</span><br/>
	<?php echo form_password(array('required'=>'required','name'=>'contrasenya', 'id'=>'contrasenya', 'type'=>'password','value'=>set_value('contrasenya'), 'placeholder' => 'Ejm: AAaa44 ó AAAaaa444', 'autofocus'=>'autofocus', 'size'=>'25'))?>
