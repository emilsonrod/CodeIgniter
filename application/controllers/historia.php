	...
	{    
		if(isset($this->session->userdata['usuario'])){
         ...
         $this->form_validation->set_message('unicaHistoria', 'Ya existe esta historia de usuario');
           ...
           {	$historias= $this->historiaUsuario->getHistorias($this->session->userdata('id'));
                if($historias!==false){
		  ...
		  {   
              ...
              if($this->historiaUsuario->agregarNuevaHistoria($this->session->userdata('id'),$nuevaHistoria)){
               $data['historias']= $this->historiaUsuario->getHistorias($this->session->userdata('id'));
               $this->load->view('vistaHistoria',$data);
              }else{
